                ...
                <Row className="mt-5 mb-5">
                    ...
                    <Col sm={2} md={2} lg={6}>
                        <div data-aos='flip-up' className="text-w p-3">
                            ...
                            <p>Hey, My name is Alamin. I am from Jhenidah. I am graduated in Computer Science and Engineering from Daffodil International University.  Now I am a full-stack Engineer.
